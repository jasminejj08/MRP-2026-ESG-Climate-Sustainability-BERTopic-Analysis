...
This paper aims to complement current research by taking a closer look at the \textit{linguistic} patterns and themes pertaining to the E (environmental) pillar, specifically the climate domain, to analyze the language temporally. Such opportunity-framed climate-related language, which we coin as “green language”, is studied to track drift over time by analyzing how companies talk about what they report. 
